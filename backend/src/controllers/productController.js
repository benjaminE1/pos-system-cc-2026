...
const { uploadImageToBlob } = require('../config/azureBlob');
...
const create = async (req, res) => {
  try {
    ...
    const imagen_url = req.file ? await uploadImageToBlob(req.file) : null;
...
const update = async (req, res) => {
  try {
    ...
    const imagen_url = req.file ? await uploadImageToBlob(req.file) : undefined;
